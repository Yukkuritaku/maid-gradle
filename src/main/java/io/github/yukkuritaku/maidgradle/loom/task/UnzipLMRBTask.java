...
public abstract class UnzipLMRBTask extends Copy {

    @Input
    public abstract Property<String> getMinecraftVersion();

    public UnzipLMRBTask(){
    ...
    public void run(){
        ...
        from(maidGradleExtension.getLMRBOutputDirectory().file(MaidConstants.LittleMaidJarFileUrls.versionConvert(meta.id())));
        into(maidGradleExtension.getLMRBOutputDirectory());
    }
